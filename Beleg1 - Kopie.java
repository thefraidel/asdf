...
public class Beleg1{
    ...
    private static void initialisiereBaustelle(){
        //Initialisiere Szenario (Strasse + 2 Lagerpl�tze)
    ...
    private static void simuliereBaustelle(int lkwAnzahl){
        ...
        for(int i = 0; i < lkwAnzahl; i++){
            ...
            //TODO BEGIN A3 
            LKW lkw;//Variablenname f�r LKW: lkw
            ...
            //Do-While-Schleife die LKW mit Materialien bel�dt, solange dieser noch Material aufnehmen kann
            ...
            do{
                 ...
                 gewichtW�re = gewichtIst+gewichtSchauf;
                ...
                //TODO BEGIN A5
                if( gewichtW�re <= lkw.getMaxZuladung()){  //TODO END A5
                    
                    gewichtIst= gewichtW�re;
            ...
            //LKW f�hrt zum ersten Lagerplatz   
            lkw.fahre(170);
            ...
            //LKW f�hrt zum zweiten Lagerplatz
            lkw.fahre(230);
            lkw.drehen(90);
            lkw.fahre(300);
